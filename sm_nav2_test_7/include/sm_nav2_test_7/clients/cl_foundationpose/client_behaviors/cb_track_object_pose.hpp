...
public:
  ...
  virtual void onEntry() override
  {
    ...
    objectTracker_->getGlobalPose(objectToTrackId_, globalFrame_); 
    RCLCPP_INFO(getLogger(), "CbTrackObjectPose onEntry - getGlobalPose, objectToTrackId: %s, globalFrame: %s", objectToTrackId_.c_str(), globalFrame_.c_str());
  }
