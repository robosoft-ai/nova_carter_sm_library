...
def generate_launch_description():
    ...
    sm_nav2_test_4_dir = get_package_share_directory("sm_nav2_test_4")
    sm_nav2_test_4_launch_dir = os.path.join(sm_nav2_test_4_dir, "launch")
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(sm_nav2_test_4_dir, "config", "navigation_tree.xml"),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(sm_nav2_test_4_dir, "rviz", "nav2_default_view.rviz"),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            sm_nav2_test_4_dir, "maps", "improved_carter_warehouse_navigation.yaml"
        ),
    ...
    sm_nav2_test_4_node = Node(
        ...
        executable="sm_nav2_test_4_node",
        name="SmNav2Test4",
        output="screen",
        ...
        parameters=[
            os.path.join(
                get_package_share_directory("sm_nav2_test_4"),
                "config/sm_nav2_test_4_config.yaml",
            )
        ],
        remappings=[
            # ("/odom", "/odometry/filtered"),
            # ("/sm_nav2_test_4_2/odom_tracker/odom_tracker_path", "/odom_tracker_path"),
            # ("/sm_nav2_test_4_2/odom_tracker/odom_tracker_stacked_path", "/odom_tracker_path_stacked")
        ],
