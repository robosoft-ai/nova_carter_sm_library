...
def generate_launch_description():
    ...
    #config = "/opt/ros/humble/share/isaac_ros_detectnet/config/params_isaac_sim.yaml"
    config = os.path.join( launch_dir_path , '../config/params_isaac_sim.yaml')
    ...
    return LaunchDescription([
        detectnet_container, 
        detectnet_encoder_launch,
        detectnet_visualizer_node, 
        rqt_image_view_node
    ])
