 ...
 ![sm_nav2_test_9](docs/SmNav2Test9_2025-4-11_224818.svg)
...
Launch the application
 ```
ros2 launch sm_nav2_test_9 sm_nav2_test_9_launch.py 
 ```
 ## Launch Description
 The initial launch file, sm_nav2_test_9_launch.py launches a SMACC Node and a Keyboard Server. 
