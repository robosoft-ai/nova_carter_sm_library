...
struct StLaunchNavStack
  ...
  static void staticConfigure() 
  {
    ...
    // configure_orthogonal<OrSlam, CbRosLaunch2>("sm_nav2_test_9", "slam_stack_launch.py", smacc2::client_behaviors::RosLaunchMode::LAUNCH_DETTACHED);

    configure_orthogonal<OrNavigation, CbRosLaunch2>("sm_nav2_test_9", "nav2_stack_launch2.py", smacc2::client_behaviors::RosLaunchMode::LAUNCH_DETTACHED);
    // configure_orthogonal<OrNavigation, CbRosLaunch2>("sm_nav2_test_9", "nav2_stack_launch.py", smacc2::client_behaviors::RosLaunchMode::LAUNCH_DETTACHED);
