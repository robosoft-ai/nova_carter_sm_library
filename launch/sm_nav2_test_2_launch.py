...
def generate_launch_description():
    ...
    sm_nav2_test_2_dir = get_package_share_directory("sm_nav2_test_2")
    sm_nav2_test_2_launch_dir = os.path.join(sm_nav2_test_2_dir, "launch")
    ...
    # urdf = os.path.join(sm_nav2_test_2_dir, "urdf", "turtlebot3_waffle.urdf")
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        # default_value=os.path.join(sm_nav2_test_2_dir, "config", "sm_nav2_test_2_navigation_params.yaml"),
        default_value=os.path.join(
            sm_nav2_test_2_dir, "config", "rtx_carter_navigation_params.yaml"
        ),
    ...
    declare_bt_xml_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(sm_nav2_test_2_dir, "config", "navigation_tree.xml"),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        "rviz_config_file",
        default_value=os.path.join(sm_nav2_test_2_dir, "rviz", "nav2_default_view.rviz"),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        "map",
        default_value=os.path.join(
            sm_nav2_test_2_dir, "maps", "improved_carter_warehouse_navigation.yaml"
        ),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_nav2_test_2_launch_dir, "rviz_launch.py")),
    ...
    #     PythonLaunchDescriptionSource(os.path.join(sm_nav2_test_2_launch_dir, "bringup_launch.py")),
    #     launch_arguments={
    #         "namespace": namespace,
    ...
    #     # PythonLaunchDescriptionSource(os.path.join(sm_nav2_test_2_launch_dir, "carter_navigation.launch.py")),
    #     PythonLaunchDescriptionSource(
    #         os.path.join(sm_nav2_test_2_launch_dir, "carter_navigation_rtx.launch.py")
    #     ),
    #     launch_arguments={
    #         "namespace": namespace,
    #         "use_namespace": use_namespace,
    ...
    sm_nav2_test_2_node = Node(
        package="sm_nav2_test_2",
        executable="sm_nav2_test_2_node",
        name="SmNav2Test2",
        output="screen",
        ...
        parameters=[
            os.path.join(
                get_package_share_directory("sm_nav2_test_2"),
                "config/sm_nav2_test_2_config.yaml",
            )
        ],
        remappings=[
            # ("/odom", "/odometry/filtered"),
            # ("/sm_nav2_test_2_2/odom_tracker/odom_tracker_path", "/odom_tracker_path"),
            # ("/sm_nav2_test_2_2/odom_tracker/odom_tracker_stacked_path", "/odom_tracker_path_stacked")
        ],
    ...
    ld.add_action(sm_nav2_test_2_node)
