 ...
 ![sm_nav2_test_10](docs/SmNav2Test10_2025-4-11_224818.svg)
...
Launch the application
 ```
ros2 launch sm_nav2_test_10 sm_nav2_test_10_launch.py 
 ```
 ## Launch Description
 The initial launch file, sm_nav2_test_10_launch.py launches a SMACC Node and a Keyboard Server. 
