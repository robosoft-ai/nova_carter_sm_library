...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory(
        "nav2_bringup"
    )  # Comentado para cambiar a línea de invocacion local
    local_bringup_dir = get_package_share_directory("sm_nav2_test_10")
    ...
    active_slam_sel = LaunchConfiguration(
        "active_slam_sel"
    )  # Añadido para desactivar slam o alternativa
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(  # Comentado para ignorar
                ...
                condition=IfCondition(PythonExpression(["not ", slam, " and ", active_slam_sel])),
                launch_arguments={
                    "namespace": namespace,
                    "map": map_yaml_file,
                    "use_sim_time": use_sim_time,
