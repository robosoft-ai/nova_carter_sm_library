...
// STATE DECLARATION
struct StNavigateToWaypoint2 : smacc2::SmaccState<StNavigateToWaypoint2, MsNav2Test10RunMode>
{
  ...
  {
    configure_orthogonal<OrNavigation, CbNavigateGlobalPosition>(-2.00, -4.00, 0.0); //(0.0, 0.0, 0.0)
