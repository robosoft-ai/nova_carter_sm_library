...
// STATE DECLARATION
struct StNavigateToWaypoint3 : smacc2::SmaccState<StNavigateToWaypoint3, MsNav2Test10RunMode>
{
  ...
  {
    configure_orthogonal<OrNavigation, CbNavigateGlobalPosition>(-9.7, 10.85, 0.0);
