...
// STATE DECLARATION
struct StPauseToAcquireFp
    : smacc2::SmaccState<StPauseToAcquireFp , MsNav2Test10RunMode> {
  ...
  // TRANSITION TABLE
  typedef mpl::list<
    Transition<EvCbSuccess<CbSleepFor, OrNavigation>, StLoadingWaypointsFile, SUCCESS>,
    //Keyboard events
