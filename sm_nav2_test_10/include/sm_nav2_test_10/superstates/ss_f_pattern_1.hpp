...
// STATE DECLARATION
struct SsFPattern1 : smacc2::SmaccState<SsFPattern1, MsNav2Test10RunMode,
...
public:
  ...
  typedef mpl::list<
      ...
      Transition<EvLoopEnd<StiFPatternStartLoop<SsFPattern1>>,
                 StInitialReturnToOrigin, ENDLOOP> //,
  ...
  static constexpr int total_iterations() { return 31.0; }
...
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_forward_1.hpp>
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_forward_2.hpp>
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_loop_start.hpp>
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_return_1.hpp>
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_rotate_1.hpp>
#include <sm_nav2_test_10/states/f_pattern_states/sti_fpattern_rotate_2.hpp>
