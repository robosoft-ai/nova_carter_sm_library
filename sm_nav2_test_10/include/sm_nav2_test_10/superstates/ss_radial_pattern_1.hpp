...
using namespace sm_nav2_test_10::radial_motion_states;
using namespace cl_keyboard;

// STATE DECLARATION
struct SsRadialPattern1
    : smacc2::SmaccState<SsRadialPattern1, MsNav2Test10RunMode,
                         StiRadialLoopStart> {
public:
  ...
  typedef mpl::list<
      ...
      Transition<EvLoopEnd<StiRadialLoopStart>, StBatteryCheck, ENDLOOP> //,StNavigateToWaypoint3
...
#include <sm_nav2_test_10/states/radial_motion_states/sti_radial_end_point.hpp>
#include <sm_nav2_test_10/states/radial_motion_states/sti_radial_loop_start.hpp>
#include <sm_nav2_test_10/states/radial_motion_states/sti_radial_return.hpp>
#include <sm_nav2_test_10/states/radial_motion_states/sti_radial_rotate.hpp>
} // namespace SS1
} // namespace sm_nav2_test_10
