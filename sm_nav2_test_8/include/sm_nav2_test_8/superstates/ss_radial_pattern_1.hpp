...
using namespace sm_nav2_test_8::radial_motion_states;
...
public:
  ...
  typedef mpl::list<
      ...
      Transition<EvLoopEnd<StiRadialLoopStart>, StNavigateToWaypoint3, ENDLOOP> //,StNavigateToWaypoint3
...
#include <sm_nav2_test_8/states/radial_motion_states/sti_radial_end_point.hpp>
#include <sm_nav2_test_8/states/radial_motion_states/sti_radial_loop_start.hpp>
#include <sm_nav2_test_8/states/radial_motion_states/sti_radial_return.hpp>
#include <sm_nav2_test_8/states/radial_motion_states/sti_radial_rotate.hpp>
} // namespace SS1
} // namespace sm_nav2_test_8
