...
struct StRecoverStep7_a : smacc2::SmaccState<StRecoverStep7_a, MsRecover>
{
  ...
  typedef mpl::list<
     ...
     Transition<EvCbSuccess<sm_nav2_test_8::CbPositionControlFreeSpace, OrNavigation>, StRecoverStep7_b,SUCCESS>
  ...
  void foundationPoseRuntimeConfigure() 
  {
    ...
    if(dockingPose)
    {
      ...
      auto cb_position_control=this->configure<OrNavigation, sm_nav2_test_8::CbPositionControlFreeSpace>();
